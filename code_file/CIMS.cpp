...
{   
	...
	void pass(int r, int s, int x, int y)
	{
		...
		do
		{
            ...
            char cha;
            int k=0;
			fin.open("C:\\TURBOC3\\Projects\\password.txt");
   			while(fin)
  				{ 	
				  	fin>>cha;
    				p1[k]=cha;
			...
			if(ch=='1')
			{
				...
				{   up:
					...
					fout.open("C:\\TURBOC3\\Projects\\password.txt");
					fout<<p1;
					fout.close();
					gotoxy(33,19);
				...
				if(c==1)
				{
					// cout << "p3:" << p3 << " & " << "p2:" << p2 << endl;  // for checking the password in file and user input
					gotoxy(33,19);
	...
	{       
		...
		{       
			...
			settextstyle(0, 0, 1);
			outtextxy(45,80, "The Topic of out project is ' Contact Information Management System '");
			outtextxy(45,115, "This is our Third Semester Project. In this programme user can save ");
			outtextxy(45,130, "contact informations of many persons of an organization. User can add,");
			outtextxy(45,145, "edit, search and delete the informations in it.");
...
{  clrscr();
  ...
  // outtextxy(r-125, s-55, "1.");
   ...
   //----- Reading Password and Saving in p1 -----
	...
	while (fin >> cha) {   // safer loop
		p1[k] = cha;
		k++;
	}
	p1[k] = '\0';   // terminate the string
	...
	// cout << "Password read from file: " << p1 << endl;
